...
esp-idf/bootloader/CMakeFiles/encrypted-bootloader-flash:
	cd /demo-mount/Voldemort/Downloads/simbot_sign_detection/build/esp-idf/bootloader && /usr/bin/cmake -E echo "Error: The target encrypted-bootloader-flash requires"
	cd /demo-mount/Voldemort/Downloads/simbot_sign_detection/build/esp-idf/bootloader && /usr/bin/cmake -E echo "CONFIG_SECURE_FLASH_ENCRYPTION_MODE_DEVELOPMENT to be enabled."
	cd /demo-mount/Voldemort/Downloads/simbot_sign_detection/build/esp-idf/bootloader && /usr/bin/cmake -E env "FAIL_MESSAGE=Failed executing target (see errors on lines above)" /usr/bin/cmake -P /demo-mount/Voldemort/Downloads/ESP-IDFv4.4/esp-idf/tools/cmake/scripts/fail.cmake
...
esp-idf/bootloader/CMakeFiles/encrypted-bootloader-flash.dir/clean:
	cd /demo-mount/Voldemort/Downloads/simbot_sign_detection/build/esp-idf/bootloader && $(CMAKE_COMMAND) -P CMakeFiles/encrypted-bootloader-flash.dir/cmake_clean.cmake
