...
esp-idf/partition_table/CMakeFiles/encrypted-partition-table-flash:
	cd /demo-mount/Voldemort/Downloads/simbot_sign_detection/build/esp-idf/partition_table && /usr/bin/cmake -E echo "Error: The target encrypted-partition-table-flash requires"
	cd /demo-mount/Voldemort/Downloads/simbot_sign_detection/build/esp-idf/partition_table && /usr/bin/cmake -E echo "CONFIG_SECURE_FLASH_ENCRYPTION_MODE_DEVELOPMENT to be enabled."
	cd /demo-mount/Voldemort/Downloads/simbot_sign_detection/build/esp-idf/partition_table && /usr/bin/cmake -E env "FAIL_MESSAGE=Failed executing target (see errors on lines above)" /usr/bin/cmake -P /demo-mount/Voldemort/Downloads/ESP-IDFv4.4/esp-idf/tools/cmake/scripts/fail.cmake
...
esp-idf/partition_table/CMakeFiles/encrypted-partition-table-flash.dir/clean:
	cd /demo-mount/Voldemort/Downloads/simbot_sign_detection/build/esp-idf/partition_table && $(CMAKE_COMMAND) -P CMakeFiles/encrypted-partition-table-flash.dir/cmake_clean.cmake
